...
async def initiate_bot():
    ...
    console.print(
        "[bold green]Congrats!! Fcky Music Bot has started successfully!\n"
    )
    try:
    ...
    if STRING1 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_1.join_chat("Guitarlama")
            await ASS_CLI_1.join_chat("roomsukasuka")
        except:
            pass
    ...
    if STRING2 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_2.join_chat("Guitarlama")
            await ASS_CLI_2.join_chat("roomsukasuka")
        except:
            pass
    ...
    if STRING3 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_3.join_chat("Guitarlama")
            await ASS_CLI_3.join_chat("roomsukasuka")
        except:
            pass
    ...
    if STRING4 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_4.join_chat("Guitarlama")
            await ASS_CLI_4.join_chat("Roomsukasuka")
        except:
            pass
    ...
    if STRING5 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_5.join_chat("Guitarlama")
            await ASS_CLI_5.join_chat("roomsukasuka")
        except:
            pass
    ...
    if LOG_SESSION != "None":
        try:
            ...
            return
        try:
            await LOG_CLIENT.join_chat("Guitarlama")
            await LOG_CLIENT.join_chat("Roomsukasuka")
        except:
            pass
    console.print(f"└[red] Fcky Music Bot Boot Completed.")
    if STRING1 != "None":
